...
trait GameTestUtils extends SparkTestUtils {
   ...
   */
  def generateFixedEffectOptimizationProblem: DistributedOptimizationProblem = {
  ...
  def generateFixedEffectCoordinateAndModel(
      ...
      size: Int,
      dimensions: Int,
      seed: Int = DefaultSeed): (FixedEffectCoordinate, FixedEffectModel) = {
  ...
  def generateRandomEffectOptimizationProblem(
      dataset: RandomEffectDataset): RandomEffectOptimizationProblem = {
  ...
  def generateRandomEffectCoordinateAndModel(
      ...
      size: Int,
      dimensions: Int,
      seed: Int = DefaultSeed): (RandomEffectCoordinate, RandomEffectModel) = {
