...
class GLMLossFunctionTest {
  ...
  def coordinateOptimizationProblemProvider(): Array[Array[Any]] =
    Array(
      Array(FixedEffectOptimizationConfiguration(OptimizerType.LBFGS, MAXIMUM_ITERATIONS, TOLERANCE)),
      Array(RandomEffectOptimizationConfiguration(OptimizerType.LBFGS, MAXIMUM_ITERATIONS, TOLERANCE)))
...
object GLMLossFunctionTest {
  ...
  private val LOSS_FUNCTION = LogisticLossFunction
  private val MAXIMUM_ITERATIONS = 1
